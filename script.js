...
const REACTION_CHARS = {
    genki: {
        empty: ["からっぽだ〜！まあここからっしょ！", "空っぽだって関係ない！これから気持ちよくなろうね", "ゼロからが一番アツい！これからどんどん盛っていこう！", "空っぽ？ぜんぜん気にしない気にしない！"],
    ...
    onesan: {
        empty: ["まだ始まったばかりだよ、ここから溜めていこう", "今日はゆっくりでいいんだよ、焦らないで", "空っぽも悪くない、いったんリセットだね", "ゼロからのスタート…すごく楽しみだね"],
    ...
    madam: {
        empty: ["あら、すっかり空になってしまいましたのね", "まだ何もございませんわね、これからですわ", "ゆるりと始めればよろしいのですわ", "焦らずに、じっくり昂っていきましょう"],
        ...
        full: ["まあ、見事な満タンでございますわ", "完璧でございます。これ以上は望めませんわね", "お見事、拍手を送らせていただきますわ", "完璧でございます、悦びを味わってくださいまし"],
        overflow: ["まあ、あふれてしまいましたわね…", "少々溜めすぎでございましょうか、ほほ", "あらあら、こぼれてしまいましたこと"]
    },
    kansai: {
        empty: ["なんもないやんか〜、はよ溜めな♡", "からっぽやで〜、しっかりしいや♡", "ゼロからいこか、気楽にな♡", "からっぽやと寂しいやろ？ほら、はよ満たそう♡"],
        better: ["ええ調子やん、その勢いやで♡", "ぼちぼち溜まってきたなぁ♡", "ええ感じや、その調子で頼むで♡", "おっ、昂ってきとるな、やるやんか〜♡"],
    ...
    chara: {
        ...
        hot: ["お、急に本気モードじゃん？笑", "いい顔してきたね〜、やるじゃん", "もうこぼしそう、大丈夫〜？笑", "さっきまでの空っぽ何だったの？笑", "いい感じになってきたね。興奮してんじゃん笑", "このまま溢れさせちゃう気でしょ？笑"],
    ...
    bunseki: {
        ...
        better: ["順調に増加中。このペースを維持", "データは右肩上がり。興奮が可視化されてきた", "数値は安定して上昇している", "悪くない進捗。継続を推奨する"],
    ...
    junsui: {
        empty: ["あら、空っぽなのですね。これから増えるのが楽しみです！", "何もない状態も、なんだか神秘的に見えてきました", "わたし、ゼロから始まるのって素敵だと思います", "空っぽさん、これからよろしくお願いしますね"],
    ...
    shitsuji: {
        empty: ["何もおありになりませんね…ご主人様、情けないですよ", "何も入っておりませんね。お紅茶でもお淹れしてお待ちします", "ゼロからのスタート…私がしっかり導いて差し上げます", "これがご主人様の実力でございますか？正直、拍子抜けでございます"],
    ...
    kouhai: {
        ...
        better: ["お、ちょっと溜まってきたじゃないっすか", "やればできるんすね、先輩。意外〜", "まあまあっすね。もうちょい頑張りましょ？", "順調っぽいっすね、ふーん"],
        hot: ["お〜、先輩やるじゃないっすか！", "もうちょいで満タンっすよ、頑張って〜", "先輩、もう限界っすか？笑 まだまだ行けますよ", "あと少しっすよ、ここで止めたらダサいっす", "先輩のそういうとこ、好きっすよ。もっと見せて", "先輩がこんなにやるとか、レアっすね笑"],
