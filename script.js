...
let REACTION_CHARS = {
    genki: {
        ...
        overflow: ["うわ溢れてる！盛り上がりすぎ〜！", "あふれた！もう手に負えないって！", "溢れちゃった！でもそれだけ証拠だね"]
    },
    onesan: {
        empty: ["まだ始まったばかりだよ、ここから溜めていこう", "今日はゆっくりでいいんだよ、焦らないで", "空っぽも悪くない、いったんリセットだね", "空っぽな今のきみも、ちゃんと見てるよ"],
        better: ["お、だいぶ溜まってきたね。手応え感じてきたでしょ？", "うんうん、順調そのものだよ。やる気が出てきた？", "ちゃんと前に進んでるよ、えらい", "ここまで来たら、止まらないでね…、その調子"],
        hot: ["もうすぐ満タンだよ、楽しみだね", "見てるこっちまで嬉しくなってきた", "ここまで頑張ったの、すごいことだよ", "すごいすごい、あと少しで満タンだね", "きみならフルまで行けるって信じてたよ？", "いい流れ来てる、この勢いに乗っちゃえ"],
        full: ["満タンだ〜！よくここまで溜めたね", "完璧、お疲れさま。ゆっくり休んでね", "こんなにいっぱいになって、嬉しそうだね", "たくさん頑張ったんだね…もう力を抜いていいよ"],
    ...
    amae: {
        ...
        hot: ["ふふ、いい顔になってきたじゃん", "もうこぼしそうだけど大丈夫？", "調子乗りすぎて溢れさせないでよ〜", "急にアツくなっちゃって、どうしたの〜", "このまま溢れさせちゃう気でしょ、欲張りさん", "ねえ、このまま最後までやる？それとも…ここでやめとく？"],
    ...
    madam: {
        empty: ["あら、すっかり空になってしまいましたのね", "まだ何もございませんわね、これからですわ", "ゆるりと始めればよろしいのですわ", "焦らずに、じっくり進めていきましょう"],
        ...
        full: ["まあ、見事な満タンでございますわ", "完璧でございます。これ以上は望めませんわね", "お見事、拍手を送らせていただきますわ", "完璧でございます、達成感を味わってくださいまし"],
    ...
    otouto: {
        empty: ["からっぽだね…でもこれから溜めよ！", "なんにもないね、でも大丈夫だよ！", "ゼロからがんばろ、ぼくも応援する！", "空っぽでもへいきへいき！"],
        better: ["やった、溜まってきたね！すごいよ！", "いい感じだ、その調子だよ！", "ちょっとずつ増えてる、えらい！", "順調だね、がんばって！"],
    ...
    chara: {
        ...
        hot: ["お、急に本気モードじゃん？笑", "いい顔してきたね〜、やるじゃん", "もうこぼしそう、大丈夫〜？笑", "さっきまでの空っぽ何だったの？笑", "いい感じになってきたね。張り切ってんじゃん笑", "そのまま行ったら溢れるって、強気じゃん？笑"],
    ...
    bunseki: {
        ...
        better: ["順調に増加中。このペースを維持", "データは右肩上がり。やる気が可視化されてきた", "数値は安定して上昇している", "悪くない進捗。継続を推奨する"],
    ...
    ojousama: {
        empty: ["空っぽですって？まったく、だらしないこと", "これっぽっちもないなんて、見ていられませんわ", "わたくしを退屈させないでくださる？", "ゼロですの…はぁ、世話の焼ける"],
        better: ["あら、少しはやる気を出したのね。褒めてはいませんわよ", "まだ半分にも満たないくせに、得意げにしないこと", "ふん、その程度で満足されては困りますわ", "まあ…悪くはなくてよ。あくまで「悪くはない」だけ"],
        hot: ["あら、やればできるじゃありませんの。意外ですわ", "ふふっ、ようやくわたくしの目に適う量になってきましたわ", "調子に乗らないこと…でも、まあ、いい感じですわね", "もう少しでフルですわよ。気を抜いたら承知しませんから", "べ、別に期待などしていませんけれど…いい線ですわ", "ここまで来たのですから、最後までやり遂げなさい"],
        full: ["満タン…ふん、当然の結果ですわ。褒めてあげなくもなくてよ", "まあ！…っ、べ、別に感心などしていませんわよ？", "やればできるではありませんの。最初からそうなさい", "完璧ですわね。…ほんの少しだけ、見直しましてよ"],
        overflow: ["溢れさせるなんて、はしたないですわ！", "まったく、加減を知らないのですから…でも嫌いじゃなくてよ", "やりすぎですわ。でも…まあ、あなたらしいこと"]
    },
    junsui: {
        empty: ["あら、空っぽなのですね。これから増えるのが楽しみです！", "何もない状態も、なんだか神秘的に見えてきました", "わたし、何もないところから見るのが好きなんです", "空っぽさん、これからよろしくお願いしますね"],
        better: ["わぁ、少し溜まってきましたね！すごいです", "これが「溜まる」ということなのですね…感動です", "順調みたいで、わたしまで嬉しくなってきました", "ちょっとずつ増えていくの、見ていて飽きません"],
        hot: ["わぁぁ、こんなに溜まるものなのですね！", "すごい、すごいです…！胸がドキドキしてきました", "もう少しで満タンって…なんて素晴らしいのでしょう", "こんなに溜まったの、わたし初めて見ました！", "きらきらして見えます…これが頑張った証なのですね", "あと少し…！わたし、最後まで見届けたいです"],
        full: ["満タン…！こんなに美しいものだったのですね", "わぁ、いっぱいです！夢みたいです…！", "すごい、本当にすごいです…！感動で言葉が出ません", "満タンって、こんなに胸がいっぱいになるのですね"],
        overflow: ["えっ、溢れてしまいました…！これも初めて見ます！", "こんなに溢れるなんて…世界は広いのですね", "わぁ大変、でもなんだか…すごく綺麗です！"]
    },
    shitsuji: {
    ...
    ai: {
        ...
        hot: ["数値が急上昇。まもなく限界値です", "進捗データが加速しています。目標値まであと少し", "数値を確認。ピーク到達は時間の問題と予測する", "進捗速度が上昇中。目標値に近づいています", "蓄積率は理想値に近い。継続を推奨"],
        full: ["完全に満たされました。データとして優秀です", "完璧な結果。達成率100%を記録", "これ以上の蓄積は不可能です。おめでとうございます", "満タン状態を確認。申し分ない数値だ"],
        overflow: ["上限超過。数値は計測不能です", "上限を逸脱。予想以上の溢出です。", "オーバーフローを検知。ユーザーは制御を失いました"]
    },
    seijo: {
